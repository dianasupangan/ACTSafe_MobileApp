                  ...
                  <tbody>
                    <?php
                      $records = mysqli_query($db,
                        "SELECT a.id_number, a.first_name, b.covid_infection_status, c.school
                        FROM user a, health_declaration_form b, student_user_info c
                        WHERE b.id_number=a.id_number AND c.id_number=a.id_number AND c.school = '$school'"
