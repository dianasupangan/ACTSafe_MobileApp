...
<body OnLoad="document.myForm.searchExit.focus();">
        ...
        <form class="form-horizontal" name="myForm"action="#" method="post">
          <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="searchExit" onkeyup="submitT(this,this.form)" placeholder="search here">
                </div>
            </div>
            ...
            <div class="col-md-2">
              ...
              <div class="col-md-8">
                ...
                <?php
                      ...
                      $records = mysqli_query($db,
                        "SELECT * FROM exit_log WHERE id_number = '$id_number'"
                      ); // fetch data from database
                  ...
                  <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary"><?php echo $data['exit_timedate']; ?></span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0">Cleared For Exit:</h6>
              ...
              <?php 
                $records = mysqli_query($db,
                "SELECT * FROM health_declaration_form a, exit_log b WHERE a.id_number=b.id_number AND a.id_number='$id_number'"
                ); // fetch data from database
              ...
              <div class="approved">
                ...
                <strong>Clear!</strong> This person is clear for exit.
              </div>  
            <?php
              }
            ...
            <div class="exposed">
              <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
              <strong>Warning!</strong> This person is not clear for exit.
            </div>  
            <?php
              }
