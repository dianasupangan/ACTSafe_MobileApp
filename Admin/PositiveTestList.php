...
<head>
  <title>Positive Test List</title>
</head>
        ...
        <div class="col-lg-8 col-md-6 d-flex align-items-stretch">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              ?>
              <tr>
                <th scope="row"><a href="PositiveTest.php?id_number=<?php echo $data['id_number']?>"><?php echo $data['id_number']?></a></th>
