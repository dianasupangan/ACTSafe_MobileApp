...
<head>
  <title>Positive Test Confirmation</title>
</head>
      ...
      <div class="container">
        <div class="main-body" data-aos="fade-up">
              ...
              <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active">Positive Test Confirmation</li>
                </ol>
              </nav>
              <!-- /Breadcrumb -->
                  ...
                  <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <?php
                          if($data['covid_infection_status'] == "Yes"){
                        ?>
                        <span class="text-secondary">Positive</span>
                        <?php
                          }
                          elseif($data['covid_infection_status'] == "No"){
                        ?>
                        <span class="text-secondary" style="color:green;">Negative</span>
                        <?php
                          }
                          ?>
                      </li>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-3">
                          ...
                          <?php 
                            $records = mysqli_query($db,
                            "SELECT photo_link FROM positive_test WHERE id_number='$id_number'"
                            ); // fetch data from database
                      ...
                      <div class="row">
                        ...
                        <form method="POST" action="PositiveTest.php" style="margin: 0px 1px 0px;">
                          ...
                          <div class="form-group">
                              <button type="submit" name="positiveTest" class="btn btn-success">Update Record</button>
                          </div>
                        </form>
                        </div>
                      </div>
