          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
              <div class="box">
                <h3>Student</h3>
                <ul>
                  <li>Create Multiple Student Profile</li>
                </ul>
                <div class="btn-wrap">
                  <a href="AddMultipleUsers(Student).php" class="btn-buy">Continue</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
              <div class="box">
                <h3>Staff</h3>
                <ul>
                  <li>Create Multiple Staff Profile</li>
                </ul>
                <div class="btn-wrap">
                  <a href="AddMultipleUsers(Staff).php" class="btn-buy">Continue</a>
                </div>
              </div>
            </div>
          </div>
