                  ...
                  <tbody>
                    <?php
                      $records = mysqli_query($db,
                        "SELECT a.id_number, a.first_name, b.covid_infection_status, c.department
                        FROM user a, health_declaration_form b, staff_user_info c
                        WHERE b.id_number=a.id_number AND c.id_number=a.id_number AND c.department = '$department'"
